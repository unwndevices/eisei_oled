...
void SceneSplashScreen::OnCreate()
{
    ...
    for (auto i = 0; i < 93; i++)
    {
        intro_full->AddFrame((const uint8_t *)intro, i, 128, 128, 80);
    }
    ...
    animation->AddAnimationAction(AnimationState::Idle, FacingDirection::Right, 92, std::bind(&SceneSplashScreen::NextScene, this));
