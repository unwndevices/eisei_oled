...
public:
    ...
    void Load(const uint8_t texture[], uint8_t width, uint8_t height, uint8_t matte = 0x8);
    void Load(const bool texture[], uint8_t width, uint8_t height, uint8_t matte = 0x8);
    void LoadFrame(const uint8_t texture[], uint8_t frameId);
    void LoadFrame(const bool texture[], uint8_t frameId);
